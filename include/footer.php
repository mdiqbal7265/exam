<footer id="dk-footer" class="dk-footer mt-4">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-4">
                ...
                <div class="footer-awarad">
                    ...
                    <p>Better Learning, Better Solution</p>
                </div>
            </div>
            <!-- End Col -->
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <span>Copyright © 2022, All Right Reserved | Developer By <a href="https://facebook.com/iqbaljmrabby" target="_blank">Md Iqbal</a></span>
                </div>
                <!-- End Col -->
                <div class="col-md-6">
...
<!-- Enroll Modal -->
<?php include 'include/details_modal.php'; ?>
<!-- Enroll Modal -->

<!-- Enroll Modal -->
<?php include 'include/syllabus_modal.php'; ?>
<!-- Enroll Modal -->